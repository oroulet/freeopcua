...
namespace OpcUa
{
  ...
  public:
    ...
    public:
      virtual CreateSubscriptionResult CreateSubscription(const CreateSubscriptionRequest&, std::function<void (PublishResult)> callbackPublish) = 0; 
      ...
      virtual CreateMonitoredItemsResult CreateMonitoredItems(const CreateMonitoredItemsParameters& parameters) = 0; 
