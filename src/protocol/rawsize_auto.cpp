...
{   
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.Header) + RawSize(data.Parameters);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.Header) + RawSize(data.DeleteSubscriptions);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.Header) + RawSizeContainer(data.Results) + RawSizeContainer(data.DiagnosticInfos);
    }
    ...
    {
        return RawSize(data.MaxAge) + RawSize(data.TimestampsToReturn) + RawSizeContainer(data.AttributesToRead);
    }
    ...
    {
        return RawSize(data.HistoryReadDetails) + RawSize(data.TimestampsToReturn) + RawSize(data.ReleaseContinuationPoints) + RawSizeContainer(data.AttributesToRead);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.NodeId) + RawSize(data.PerformInsertReplace) + RawSizeContainer(data.UpdateValues);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.NodeId) + RawSize(data.IsDeleteModified) + RawSize(data.StartTime) + RawSize(data.EndTime);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.NodeId) + RawSizeContainer(data.ReqTimes);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.NodeId) + RawSizeContainer(data.EventIds);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.ObjectId) + RawSize(data.Parameters);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.ItemToMonitor) + RawSize(data.Parameters);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.MonitoredItemId) + RawSize(data.Parameters);
    }
    ...
    {
        return RawSize(data.Encoding) + RawSize(data.TypeId) + RawSize(data.BodyLength) + RawSize(data.NodeId) + RawSize(data.PerformInsertReplace) + RawSize(data.Filter) + RawSizeContainer(data.EventData);
    }
