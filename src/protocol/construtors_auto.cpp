...
{   
        ...
        : TypeId(ObjectId::HistoryUpdateResponse_Encoding_DefaultBinary)
    {
     ...
     CallMethodRequest::CallMethodRequest()
        : TypeId(ObjectId::CallMethodRequest_Encoding_DefaultBinary)
    {
    }
        ...
        : TypeId(ObjectId::CallResponse_Encoding_DefaultBinary)
    {
     ...
     MonitoredItemCreateRequest::MonitoredItemCreateRequest()
        : TypeId(ObjectId::MonitoredItemCreateRequest_Encoding_DefaultBinary)
    {
    }
        ...
        : TypeId(ObjectId::CreateMonitoredItemsResponse_Encoding_DefaultBinary)
    {
     ...
     MonitoredItemModifyRequest::MonitoredItemModifyRequest()
        : TypeId(ObjectId::MonitoredItemModifyRequest_Encoding_DefaultBinary)
    {
    }
