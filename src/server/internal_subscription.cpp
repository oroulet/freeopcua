...
namespace OpcUa
{
  namespace Internal
  {
    ...
    InternalSubscription::InternalSubscription(SubscriptionServiceInternal& service, const CreateSubscriptionResult& data, const NodeId& AuthenticationToken, std::function<void (PublishResult)> callback, bool debug)
      : Service(service)
